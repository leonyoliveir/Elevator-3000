...
K_SYSCALL_DECLARE1(K_SYSCALL_K_USLEEP, k_usleep, s32_t, s32_t, us)
...
K_SYSCALL_DECLARE3(K_SYSCALL_K_FUTEX_WAIT, k_futex_wait, int, struct k_futex *, futex, int, expected, s32_t, timeout)

K_SYSCALL_DECLARE2(K_SYSCALL_K_FUTEX_WAKE, k_futex_wake, int, struct k_futex *, futex, bool, wake_all)

K_SYSCALL_DECLARE2(K_SYSCALL_K_STACK_ALLOC_INIT, k_stack_alloc_init, s32_t, struct k_stack *, stack, u32_t, num_entries)

K_SYSCALL_DECLARE2_VOID(K_SYSCALL_K_STACK_PUSH, k_stack_push, struct k_stack *, stack, stack_data_t, data)
...
K_SYSCALL_DECLARE1(K_SYSCALL_K_FLOAT_DISABLE, k_float_disable, int, struct k_thread *, thread)
